# coding=UTF-8
#
# !!! 	   this is an experimental port of tcpdf 	   !!!
# !!! done by Jean Tinguely Awais / http://www.t-servi.com !!!
...
## Teus Hagen for several suggestions and fixes. Yukihiro Nakadaira for CID-0 CJK fonts fixes. Kosmas Papachristos for some CSS improvements.
...
# document creator
PDF_CREATOR = "TCPDF-Python"
# document author
PDF_AUTHOR = "TCPDF-Python"
# header title
PDF_HEADER_TITLE = "TCPDF-Python Example"
# header description string
PDF_HEADER_STRING = "by Nicola Asuni - Tecnick.com\nwww.tcpdf.org - port by Jean Tinguely Awais - http://www.t-servi.com"
# image logo
...
PDF_PRODUCER = 'TCPDF-Python (http://www.t-servi.com) from TCPDF 4.0.027 (http://www.tcpdf.org)'


class TCPDF(object):
	def __init__(self, orientation='P', unit='mm', format='A4', unicode=True, encoding="UTF-8"):
		""" constructor """
		self.page=0
		self.n=0
		self.offsets={}
		...
		self.footer_margin=1
		self.original_lMargin=1
		self.original_rMargin=1
		self.header_font=''
		self.footer_font=''
		self.l=''
		self.barcode = False
		...
		self.header_logo = ""
		self.header_logo_width = 30
		self.header_title = ""
		self.header_string = ""
		self.default_table_columns = 4
		self.HREF=''
		self.fontlist = {}
		self.fgcolor=''
		self.listordered = {}
		...
		self.extgstates=''
		self.jpeg_quality=''
		self.cell_height_ratio = K_CELL_HEIGHT_RATIO;
		...
		self.endlinex = 0
		self.linestyleWidth = ""
		self.linestyleCap = "0 J"
		self.linestyleJoin = "0 j"
		self.linestyleDash = "[] 0 d"
		self.openMarkedContent = False
		self.htmlvspace = 0
		self.spot_colors = {}
		# initialisation
		self.internal_encoding = mb_internal_encoding()
		self.mb_internal_encoding("ASCII")
		#self.rtl = self.l['a_meta_dir']=='rtl' ? true : False
		self.rtl = False
		if 'rtl' == self.l['a_meta_dir'] :
			self.rtl= True
		self.tmprtl = False
		self._dochecks()
		...
		self.last_rc4_key = ''
		self.padding = "\x28\xBF\x4E\x5E\x4E\x75\x8A\x41\x64\x00\x4E\x56\xFF\xFA\x01\x08\x2E\x2E\x00\xB6\xD0\x68\x3E\x80\x2F\x0C\xA9\xFE\x64\x53\x69\x7A"
		self.CoreFonts = {'courier':'Courier',
		...
		self.setPageUnit(unit)
		self.setPageFormat(format, orientation)
		margin = 28.35 / self.k
		self.SetMargins(margin,margin)
		self.cMargin = margin / 10
		self.LineWidth = 0.57 / self.k
		self.linestyleWidth = '%.2f w'% (self.LineWidth * self.k)
		self.linestyleCap = "0 J"
		self.linestyleJoin = "0 j"
		self.linestyleDash = "[] 0 d"
		...
		self.extgstates = {}
		self.ur = False
		self.ur_document = "/FullSave"
		self.ur_annots = "/Create/Delete/Modify/Copy/Import/Export"
		self.ur_form = "/Add/Delete/FillIn/Import/Export/SubmitStandalone/SpawnTemplate"
		self.ur_signature = "/Modify"
