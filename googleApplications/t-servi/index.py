...
class recherche(webapp.RequestHandler):
	...
	dict={'clef':'Titre','contexte':'Email','version':'version','valeur':'Annonce'}
        for c in mesClefs:
         for t in requeteTable:
        ...
        if toutTrouve:
         ...
         for c in mesClefs:
		  if dict.has_key(c):
           		texte+="<tr><td>"+str(dict[c])+"</td><td>"+str(eval("r."+c)).replace('@','_at_')+"</td></tr>\n"
		  else:
           		texte+="<tr><td>"+str(c)+"</td><td>"+str(eval("r."+c)).replace('@','_at_')+"</td></tr>\n"
         texte+="</table>"
         texte+="</td></tr>\n"
...
class insere(webapp.RequestHandler):
    def post(self):
     ...
     if lastVersion==0.0:
      rep+="<tr><td>Sont enregistr&eacute;ees dans la base de donn&eacute;e.</td></tr>\n"
     else:
...
%s
<b>D&eacute;poser et chercher dans une base de donn&eacute;e de petites annonces</b>
%s
"""%(cartoucheDessus, cartoucheDessous)
...
<br/>
%s
 cr&eacute;&eacute; par <a href="http://www.t-servi.com">http://www.t-servi.com</a> - sans garanties - sans but lucratif - code source de l'appliction <a href="http://www.t-servi.com/cgi-bin/trac.cgi/browser/googleApplications/t-servi">ici</a>
%s
</body>
"""%(cartoucheDessus, cartoucheDessous)
...
Recherchez une annonce en entrant un crit&egrave;re de recherche et appuyez sur enter : <input type="text" name="requete" style="width:600px"/>
</form>
<br>
</div>
%s
...
<tr><td>
Donnez un titre &agrave; votre annonce :
</td></tr>
<tr><td>
<input type="text" name="clef" value="" style="width:600px;" />
</td></tr>
<tr><td>
Donnez votre adresse email :
</td></tr>
<tr><td>
<input type="text" name="contexte" value="" style="width:600px" />
</td></tr>
<tr><td>
Ins&eacute;rez votre annonce gratuite :
</td></tr>
<tr><td>
<textarea name="valeur" id="valeur" style="width:600px;height:350px;" ></textarea>
</td></tr>
<tr><td>
<input type="submit" />
<tr><td>
